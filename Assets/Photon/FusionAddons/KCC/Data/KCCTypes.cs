namespace Fusion.Addons.KCC
{
	...
	/// <summary>
	/// Defines update behavior for KCC proxy.
    /// <list type="bullet">
    /// <item><description>Skip Fixed | Interpolate Render - Skips processing in fixed update, interpolation between server state snapshots in render update.</description></item>
    /// <item><description>Interpolate Fixed | Interpolate Render - Interpolation between server state snapshots in fixed update, interpolation between server state snapshots in render update.</description></item>
    /// <item><description>Predict Fixed | Interpolate Render - Full processing/prediction in fixed update, interpolation between last two predicted fixed update states in render update.</description></item>
    /// <item><description>Predict Fixed | Predict Render - Full processing/prediction in fixed update, full processing/prediction in render update.</description></item>
    /// </list>
	/// </summary>
	public enum EKCCProxyBehavior
	{
		SkipFixed_InterpolateRender        = 0,
		InterpolateFixed_InterpolateRender = 1,
		PredictFixed_InterpolateRender     = 2,
		PredictFixed_PredictRender         = 3,
	}
	...
	/// <summary>
	/// Defines network replication behavior of the KCC to players.
    /// <list type="bullet">
    ...
    /// </list>
	/// </summary>
	public enum EKCCReplicationMode
	{
		Default   = 0,
		Inclusive = 1,
		Exclusive = 2,
