namespace Fusion.Addons.KCC
{
	...
	public partial class KCC
	{
		...
		/// </summary>
		/// <param name="shapeCastInfo">Contains results of the cast.</param>
		...
		/// <param name="maxDistance">Distance of the cast.</param>
		/// <param name="triggerInteraction">Use to enable/disable trigger hits.</param>
		public bool SphereCast(KCCShapeCastInfo shapeCastInfo, Vector3 position, float radius, Vector3 direction, float maxDistance, QueryTriggerInteraction triggerInteraction)
		{
			return SphereCast(shapeCastInfo, Data, position, radius, default, direction, maxDistance, _settings.CollisionLayerMask, triggerInteraction);
		}
		...
		/// <param name="maxDistance">Distance of the cast.</param>
		/// <param name="triggerInteraction">Use to enable/disable trigger hits.</param>
		public bool CapsuleCast(KCCShapeCastInfo shapeCastInfo, Vector3 position, float radius, float height, Vector3 direction, float maxDistance, QueryTriggerInteraction triggerInteraction)
		{
			return CapsuleCast(shapeCastInfo, Data, position, radius, height, default, direction, maxDistance, _settings.CollisionLayerMask, triggerInteraction);
		}
		...
		private bool RayCast(KCCShapeCastInfo shapeCastInfo, KCCData data, Vector3 position, Vector3 direction, float maxDistance, LayerMask layerMask, QueryTriggerInteraction triggerInteraction)
		{
			...
			++_debug.RayCastQueries;

			return shapeCastInfo.AllHitCount > 0;
		}

		private bool SphereCast(KCCShapeCastInfo shapeCastInfo, KCCData data, Vector3 position, float radius, float extent, Vector3 direction, float maxDistance, LayerMask layerMask, QueryTriggerInteraction triggerInteraction)
		{
			shapeCastInfo.Reset(false);
			...
			++_debug.ShapeCastQueries;

			return shapeCastInfo.AllHitCount > 0;
		}

		private bool CapsuleCast(KCCShapeCastInfo shapeCastInfo, KCCData data, Vector3 position, float radius, float height, float extent, Vector3 direction, float maxDistance, LayerMask layerMask, QueryTriggerInteraction triggerInteraction)
		{
			shapeCastInfo.Reset(false);
